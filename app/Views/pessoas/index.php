        ...
        <form id="formPessoa">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control" name="documento" id="cpf" placeholder="000.000.000-00" maxlength="14" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Telefone</label>
                    <input class="form-control" name="telefone" id="telefone" placeholder="(00) 00000-0000" maxlength="17">
                </div>
                <div class="col-md-6">
                    <label class="form-label">E-mail *</label>
                    <input class="form-control" type="email" name="email" placeholder="exemplo@gmail.com" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Curso</label>
                    <input class="form-control" name="curso" placeholder="Ex: Engenharia de Software">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Período</label>
                    <input class="form-control" name="periodo" placeholder="Ex: 3º">
                </div>
                <div class="col-12">
...
telefoneInput.addEventListener('input', (e) => {
  ...
  // Formata o número com base no tamanho
  if (valor.length > 2) {
...
cpfInput.addEventListener('input', () => {
  ...
  // Aplica as máscaras dependendo da quantidade de números digitados
