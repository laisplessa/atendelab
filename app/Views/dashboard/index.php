...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        document.getElementById('totalPessoas').textContent = response.pessoas ?? 0;
        document.getElementById('totalTipos').textContent = response.tipos ?? 0;
        document.getElementById('totalAtendimentos').textContent = response.atendimentos ?? 0;
    } catch (error) {
